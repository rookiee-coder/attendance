...
<div class="container">
    ...
    <h3 class="float-start ms-5">BLOCK4</h3>
    <table>
        <thead>
        <tr>
            <th>#</th>
             ...
             if($block == 'block4')
             {
                ...
                <tr>
                    ...
                    <div class="action-container">
                        ...
                        <a class="action-btn delete-btn" href="backend/block4_delete.php?id=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                    </div>
                    </td>
                    <td>
                        <form method="POST" action="backend/block4_attendance.php">
                            <label>
